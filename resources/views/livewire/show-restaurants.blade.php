    ...
    <x-dialog-modal wire:model="showEditModal" maxWidth="md">
        ...
        <x-slot name="content">
            ...
            <div class="mt-4">
                ...
                <label for="editing.abonnement_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Abonnement</label>
                <select id="editing.abonnement_id" wire:model.defer="editing.abonnement_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <option selected>Selectionnez l'Abonnement</option>
                ...
                <x-input-error for="editing.abonnement_id" class="mt-2" />
            </div>
