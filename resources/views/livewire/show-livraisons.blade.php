<div class="relative overflow-x-auto shadow-md sm:rounded-lg bg-white p-4">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="flex items-center px-6 py-4 space-x-3">
                    <a href="#" wire:click="edit({{ $livraison }})" wire:loading.attr="disabled" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Modifier</a>
                    <a href="#" wire:click="delete({{ $livraison }})" wire:loading.attr="disabled" class="font-medium text-red-600 dark:text-red-500 hover:underline">Supprimer</a>
                </td>
            </tr>
            @endforeach
        </tbody>
    ...
    <x-dialog-modal wire:model="showEditModal" maxWidth="md">
        ...
        <x-slot name="content">
            ...
            <div class="mt-4">
                <x-input type="text" class="mt-1 block w-full" placeholder="{{ __('Decription') }}" x-ref="editing.description" wire:model.defer="editing.description"  />

                <x-input-error for="editing.description" class="mt-2" />
            </div>
            <div class="mt-4">
                <x-input type="text" class="mt-1 block w-full" placeholder="{{ __('Addrese') }}" x-ref="editing.addrese" wire:model.defer="editing.addrese"  />

                <x-input-error for="editing.addrese" class="mt-2" />
            </div>
            <div class="mt-4">
                <x-input type="text" class="mt-1 block w-full" placeholder="{{ __('Phone') }}" x-ref="editing.phone" wire:model.defer="editing.phone"  />
            ...
            <div class="mt-4">
                ...
                <div class="mt-4">
                    ...
                    <label for="editing.livreur_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Livreur</label>
                    <select id="editing.livreur_id" wire:model.defer="editing.livreur_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option selected>Selectionnez le livreur</option>
                    ...
                    <x-input-error for="editing.livreur_id" class="mt-2" />
                </div>
                <div class="mt-4">

                    <label for="editing.commande_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Commande</label>
                    <select id="editing.commande_id" wire:model.defer="editing.commande_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option selected>Selectionnez la commande</option>
                    ...
                    <x-input-error for="editing.commande_id" class="mt-2" />
                </div>
            </div>
        </x-slot>
