            ...
            @foreach ($livraisons as $livraison)
                <tr
                    ...
                    <td class="flex items-center px-6 py-4 space-x-3">
                        <a href="#" wire:click="edit({{ $livraison }})" wire:loading.attr="disabled"
                            class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Modifier</a>
                        <a href="#" wire:click="delete({{ $livraison }})" wire:loading.attr="disabled"
        ...
        <x-slot name="content">
            ...
            <div class="mt-4">
                <x-input type="text" class="mt-1 block w-full" placeholder="{{ __('PHONE') }}"
                    x-ref="editing.phone" wire:model.defer="editing.phone" disabled  />
