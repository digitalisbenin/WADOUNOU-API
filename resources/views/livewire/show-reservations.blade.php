<div class="relative overflow-x-auto shadow-md sm:rounded-lg bg-white p-4">
            ...
            @foreach ($reservations as $reservation)
                <tr
                    ...
                    <td class="flex items-center px-6 py-4 space-x-3">
                        <a href="#" wire:click="edit({{ $reservation }})" wire:loading.attr="disabled"
                            class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Modifier</a>
                        <a href="#" wire:click="delete({{ $reservation }})" wire:loading.attr="disabled"
    ...
    <x-dialog-modal wire:model="showEditModal" maxWidth="md">
        ...
        <x-slot name="content">
            <div class="mt-4">
                <x-input type="text" class="mt-1 block w-full" placeholder="{{ __('Votre nom') }}" x-ref="editing.name"
            ...
            <div class="mt-4">
                <x-input type="text" class="mt-1 block w-full" placeholder="{{ __('Place') }}"
                    x-ref="editing.place" wire:model.defer="editing.place"  />

                <x-input-error for="editing.place" class="mt-2" />
            </div>
            <div class="mt-4">
                <x-input type="text" class="mt-1 block w-full" placeholder="{{ __('Date') }}"
                    x-ref="editing.date" wire:model.defer="editing.date"  />
            ...
            <div class="mt-4">
                ...
                <select id="editing.role_id" wire:model.defer="editing.restaurant_id"
